...
$S$. Le groupe quotient $(S_{\mathfrak{p}}S)/S_{\mathfrak{p}}$ permet de ne
faire apparaitre uniquement les conjugués de $\mathfrak{p}$ a la puissance $1$.
En intersectant avec $\EO_m^S$, on obtient alors la décomposition de $p\EO_m^S$.
...
où $e'$ est l'indice de ramification de $\mathfrak{p}$ dans $\EO_m^S$, ici égal 
à $1$, et $f'$ le degré du corps résiduel.\\
\end{proof}
