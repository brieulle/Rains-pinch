...
\end{defn}
\begin{rem}
La notion est très proche de la notion d'éléments conjugués, la seule différence
est de niveau formel. Si on considère les corps $k_1$ et $k_2$ comme deux objets
différents, alors on ne peut pas considérer un isomorphisme entre les deux comme
un automorphisme.
\end{rem}
