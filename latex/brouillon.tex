...
cyclotomique, au départ on cherche un $m$ premier de la forme $an + 1$ tel que
$(\varphi(m)/n, n) = 1$. Le traitement est différent selon si $m$ est égal à $p$
ou non.\par
...
\begin{itemize}
    ...
    d'ordre $n$, on a $aoverline{q/\alpha}$ d'ordre plus grand que $n$ et 
