...
calculer les isomorphismes de corps finis. Le c\oe ur du sujet se trouve à la 
partie \ref{deux}.
...
\subsection{Algorithme de Pinch}
...
s'en sortir est dûe à Pinch, l'une des façons de procéder utilise les racines de
l'unité.
...
qu'il est premier avec $11$ puisqu'il est lui-même premier. On définit $k_1$ et 
$k_2$ comme les corps de ruptures de $f$ et $g$ respectivement.\par
